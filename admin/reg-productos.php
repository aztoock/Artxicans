			...
			<div class="table-data">
				<div class="order">
					...
					<table>
						...
						<?php 
							$query = "SELECT products.*, registro.Nombre AS nombre_registro
							FROM products
							INNER JOIN registro ON products.ID_registro = registro.ID
							WHERE products.estatus = 'Pendiente'";
						...
						?>
									<tr>
										<td>
											...
											<p><?php echo $data['nombre_registro']?></p>
										</td>
										<td>
											<p><?php echo $data['product']?></p>
										</td>
										<td><a href="pages/det-regprod.php?id_product=<?php echo $data['id_product'];?>"><span class="status completed">Ver info</span></a></td>
									</tr>
						<?php 
								}
						?>
