...
INSERT INTO `notifications` (`id_notif`, `titulo`, `notification`, `tipo`, `ID_registro`) VALUES
(1, 'Solicitud de vendedor', 'Solicitud de Vendedor Aceptada', 0, 5),
(2, 'Reporte de perfil', 'Reporte de perfil', 0, 5),
(3, 'Prueba de notificaion 3', 'Aceptado bites', 0, 11),
(6, 'Prueba de notificacion 2', 'solicitud aseptada', 0, 12),
(7, 'Reporte de comentario', 'jejejreje', 0, 12),
(8, 'prueba de notificacion', 'laskdjfklasfd', 0, 12),
(14, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(15, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(16, 'Reporte de comentario', 'Tu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 5),
(17, 'Reporte de comentario', 'Tu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 5),
(18, 'Reporte de comentario', 'Tu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 12),
(19, 'Reporte de comentario', 'Tu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 5),
(20, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(21, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(22, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(23, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(24, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(25, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 5),
(26, 'Reporte de comentario', 'Tu comentario fue reportado y ha sido eliminado.', 0, 12),
(27, 'Reporte de comentario', 'Tu comentario fue reportado', 0, 12),
(28, 'Reporte de comentario', 'Tu comentario fue reportado', 0, 12),
(29, 'Reporte de comentario', 'Tu comentario en el perfil fue reportado', 0, 12),
(30, 'Reporte de comentario', 'Tu comentario en el perfil fue reportado', 0, 12),
(31, 'Reporte de comentario', 'Tu comentario en el perfil fue reportado', 0, 12),
(33, 'Reporte de comentario', 'Tu comentario en el perfil fue reportado', 0, 12),
(34, 'Reporte de perfil de vendedor', 'Tu perfil de vendedor fue reportado.', 0, 5),
(35, 'Solicitud de vendedor', 'usuario aceptado', 0, 14),
(36, 'Reporte de producto', 'asdfTu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 5),
(37, '', '', 0, 14),
(38, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 14),
(39, 'Envio de paquete finalizado', 'El paquete a sido entregado al domicilio registrado.', 0, 14),
(40, 'Reporte de producto', 'Tu producto fue reportado, por infringir las normas, revisa tu proucto', 0, 12),
(41, '', 'Tu producto a sido actualizado con exito.', 0, 12),
(42, '', 'Tu producto a sido actualizado con exito.', 0, 12),
(43, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(44, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(45, 'Envio de paquete finalizado', 'El paquete a sido entregado al domicilio registrado.', 0, 12),
(46, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(47, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(48, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(49, 'Tu paquete se esta preparando para ser entregado a paqueteria', 'El paquete esta siendo preparado para proceso de envio.', 0, 12),
(50, 'Tu paquete esta en proceso de envio', 'El paquete a sido enviado.', 0, 12),
(51, 'Envio de paquete finalizado', 'El paquete a sido entregado al domicilio registrado jejereje', 1, 12),
(52, '', 'Tu perfil de vendedor fue reportado, por infringir las normas de la comunidad, revisa tu informacion y informa al administrador para validar los cambi', 4, 12),
(53, 'Reporte de perfil de vendedor', 'Tu perfil de vendedor fue reportado, por infringir las normas de la comunidad, revisa tu informacion y informa al administrador para validar los cambi', 4, 12),
(54, '', 'Tu comentario en el perfil de un vendedor fue reportado, por infringir las normas de la comunidad', 0, 14),
(55, ' asdfasdf', 'Tu comentario en el perfil de un vendedor fue reportado, por infringir las normas de la comunidad', 3, 12),
(56, '', 'Tu comentario en el perfil de un vendedor fue reportado, por infringir las normas de la comunidad y ha sido eliminado', 0, 14),
...
--
ALTER TABLE `stars`
  MODIFY `id_star` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
